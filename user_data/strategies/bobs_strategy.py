    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (qtpylib.crossed_above(dataframe['ema21'], dataframe['ema200']))
        ...
        #         (qtpylib.crossed_below(dataframe['ema21'], dataframe['ema200']))
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (qtpylib.crossed_below(dataframe['ema21'], dataframe['ema200']))
                # (dataframe['ema9'] - dataframe['ema21'] > 7) |
                # (dataframe['ema9'] - dataframe['ema21'] < -7) 
                #(dataframe['tema'] > dataframe['bb_middleband']) &  # Guard: tema above BB middle
                #(dataframe['tema'] < dataframe['tema'].shift(1))   # Guard: tema is falling
                #(dataframe['ha_open'] < dataframe['ha_close'])   # Make sure Volume is not 0
            ),
            'exit_long'] = 1
